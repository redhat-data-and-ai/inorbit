...
Theme and controls use a simple masthead, product cards, and Overview / Pipeline / Quality. Freshness is part of Pipeline, not a separate tab. The page only calls `/v1`.
