...
Theme and controls follow the data-product console (masthead, product cards, Health / Freshness / Pipeline / Quality tiles, Overview · Pipeline · Quality signals). The page only calls `/v1`.
